            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="single-page-header-inner">
                        <div class="left-side">
                            <div class="header-image freelancer-avatar"><img src="/applicants/image/{{ $applicant->image }}" alt="{{ $applicant->firstname }}"></div>
                            <div class="header-details">
                                <h3>{{ $applicant->firstname . " " . $applicant->lastname }} <span>{{ $applicant->title }}</span></h3>
                                <ul>
                                    {{-- <li><div class="star-rating" data-rating="5.0"></div></li> --}}
                                    <li><img class="flag" src="/images/flags/{{ strtolower($country['code']) }}.svg" alt=""> {{ $country['name'] }}</li>
