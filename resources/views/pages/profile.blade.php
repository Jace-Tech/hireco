...
@section('content')
                                                ...
                                                <div class="col-xl-6">
                                                    <div class="submit-field">
                                                        ...
                                                        <div class="attachments-container margin-top-0 margin-bottom-0">
                                                            ...
                                                            @if(optional(auth()->user()->attachment)->count())
    ...
    @else
                            ...
                            <div class="content with-padding padding-bottom-0">
                                <form action=" {{ route('profile') }} " method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        @csrf
                                        <div class="col-xs-12 col-md-3">
                                            <div class="avatar-wrapper" data-tippy-placement="bottom" title="Change Logo">
                                                @if(auth()->user()->person->logo)
                                                    <img class="profile-pic" src="/company/image/{{ auth()->user()->person->logo }}" alt="" />
                                                @else
                                                    <img class="profile-pic" src="/company/image/" alt="" />
                                                @endif
                                        ...
                                        <div class="col-xs-12 col-md-9">
                                            <div class="row">
                                                ...
                                                <div class="col-xl-6">
                                                    <div class="submit-field">
                                                        ...
                                                        @if(auth()->user()->person->name)
                                                            <input type="text" name="name" class="with-border" value="{{ auth()->user()->person->name }}">
                                                        @else
                                                            <input type="text" class="with-border" name="name" value="">
                                                        @endif
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-xl-6">
                                                    <div class="submit-field">
                                                        <h5>Company Title</h5>
                                                        @if(auth()->user()->person->title)
                                                            <input type="text" name="title" class="with-border" value="{{ auth()->user()->person->title }}">
                                                        @else
                                                            <input type="text" class="with-border" name="title" value="">
                                                        @endif
                                                    </div>
                                                </div>
                                    ...
                                    <ul class="fields-ul">
                                        <li>
                                            <div class="row">                                                
                                                <div class="col-xl-6">
                                                    <div class="submit-field">
                                                        <h5>Latitude  <i class="help-icon" style="cursor: pointer;" id="getLocation" data-tippy-placement="right" title="Click to get current position coords"></i></h5>
                                                        @if (auth()->user()->person->latitude)
                                                            <input id="autocomplete-input" required value="{{ auth()->user()->person->latitude }}" name="latitude" class="with-border" type="text" placeholder="Type latitude"> 
                                                        @else
                                                            <input id="autocomplete-input" required name="latitude" class="with-border" type="text" placeholder="Type latitude">  
                                                        @endif
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-xl-6">
                                                    <div class="submit-field">
                                                        <h5>Longitude</h5>
                                                        @if (auth()->user()->person->longitude)
                                                            <input id="autocomplete-input" required value="{{auth()->user()->person->longitude}}" name="longitude" class="with-border" type="text" placeholder="Type longitude">
                                                        @else
                                                            <input id="autocomplete-input" required name="longitude" class="with-border" type="text" placeholder="Type longitude">
                                                        @endif
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-xl-6">
                                                    <div class="submit-field">
                                                        <h5>Category</h5>
                                                        <select required name="category" class="selectpicker with-border" data-size="7" title="Choose Category" data-live-search="true">
                                                            @foreach($categories as $category)
                                                                @if(auth()->user()->person->category  == $category->id) 
                                                                    <option selected value="{{ $category->id }}">{{$category->category}}</option>
                                                                @else
                                                ...
                                                <div class="col-xl-6">
                                                    <div class="submit-field">
                                                        <h5>Nationality</h5>
                                                        <select required name="country" class="selectpicker with-border" data-size="7" title="Select Country" data-live-search="true">
                                                            @foreach ($countries as $country)
                                                                <option value="{{ $country['code'] }}" @if((auth()->user()->person->country) == $country['code']) selected  @endif> {{ $country['name'] }} </option>
                                                            @endforeach
                                                        </select>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-12">
                                                    <div class="submit-field">
                                                        <h5>Introduce Yourself</h5>
                                                        @if(auth()->user()->person->bio)
                                                            <textarea required name="bio"  cols="30" rows="5" class="with-border">{{ auth()->user()->person->bio }}</textarea>
                                                        @else
                                                            <textarea name="bio"  cols="30" rows="5" class="with-border"></textarea>
                                                        @endif
                                                    </div>
        ...
        <script>
            ...
            const long = document.querySelector('input[name="longitude"]')
            ...
            locationBtn.addEventListener('click', async (e) => {
                ...
                navigator.geolocation.getCurrentPosition(coords => {
                    long.value = coords.coords.longitude
                    lat.value = coords.coords.latitude
                })
            })
        </script>
    @endif
