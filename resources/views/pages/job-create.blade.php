				...
				<div class="col-xl-12">
					<div class="dashboard-box margin-top-0">
						...
						<div class="content with-padding padding-bottom-10">
							<form action="{{ route('job.post') }}" method="post" id="job" enctype="multipart/form-data" class="row">
                                @csrf
								<div class="col-xl-4">
								...
								<div class="col-xl-4">
									<div class="submit-field">
										...
										<input id="autocomplete-input" name="latitude" class="with-border" type="text" placeholder="Type latitude">
									</div>
								</div>
								...
								<div class="col-xl-4">
									<div class="submit-field">
										<h5>Longitude</h5>
										<input id="autocomplete-input" name="longitude" class="with-border" type="text" placeholder="Type longitude">
									</div>
								</div>
								...
								<div class="col-xl-9">
									<div class="submit-field">
										...
										<div class="row">
											<div class="col-xl-6">
												<div class="input-with-icon">
													<input class="with-border"  name="min" placeholder="Min">
											...
											<div class="col-xl-6">
												<div class="input-with-icon">
													<input class="with-border" name="max" placeholder="Max">
													<i class="currency">USD</i>
												</div>
											</div>
										</div>
